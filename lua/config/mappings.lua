...
map({ "n", "t" }, "<A-w>v", function()
    vim.cmd.vsplit()
    vim.cmd.terminal()
end, "Vertical split terminal")
map({ "n", "t" }, "<A-w>s", function()
    vim.cmd.split()
    vim.cmd.terminal()
end, "Horizontal split terminal")
map({ "n", "t" }, "<A-w>n", function()
    vim.cmd.terminal()
end, "Terminal in current window")
map({ "n", "t" }, "<A-w>t", function()
    vim.cmd.tabnew()
    vim.cmd.terminal()
end, "Terminal in new tab")

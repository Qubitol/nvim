	...
	config = function()
		...
		local LSPActive = {
...

			{
				provider = function()
					...
					return icons.kind.LSP .. " " .. table.concat(names, " ")
				end,
			},

			{
				provider = icons.kind.LSP .. " LSP",
			},
		...
		local WorkDir = {
...

			{
				{
					provider = "",
					hl = { fg = "bright_bg", bg = "red" },
				},
				{
					provider = " 󰉋",
					hl = { fg = "bright_black", bg = "red", bold = true },
				},
				{
					provider = "",

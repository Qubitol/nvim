...
local function lsp_keymaps(bufnr)
    ...
    keymap(bufnr, "n", "vgD", "<cmd>vsplit | lua vim.lsp.buf.declaration()<CR>", opts)
    keymap(bufnr, "n", "sgD", "<cmd>split | lua vim.lsp.buf.declaration()<CR>", opts)
    keymap(bufnr, "n", "gd", "<cmd>lua vim.lsp.buf.definition()<CR>", opts)
    keymap(bufnr, "n", "vgd", "<cmd>vsplit | lua vim.lsp.buf.definition()<CR>", opts)
    keymap(bufnr, "n", "sgd", "<cmd>split | lua vim.lsp.buf.definition()<CR>", opts)
    ...
    if status_trouble_ok then
        ...
        keymap(bufnr, "n", "<leader>ll", "<cmd>TroubleToggle loclist<CR>", opts)
        keymap(bufnr, "n", "<leader>lq", "<cmd>TroubleToggle quickfix<CR>", opts)
    else
